...
```
* If you have a GPU, you should see a list of GPU devices. If you don't have a GPU, you will see an empty list.
...
* Here the `pretrained_models\ is the directory where the pre-trained models are extracted.
```
...
```cmd
python -m eval.interpolator_cli --pattern "weather" --model_path pretrained_models\film_net\Style\saved_model --times_to_interpolate 6 --output_video
```
